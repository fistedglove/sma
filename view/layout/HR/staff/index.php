...
<?php if($pagination->total_pages()>1){
    ...
    &nbsp&nbsp<a class = "navLinks" href ='. '/'. APP_ROOT.'/'.'staff?status='.$status.'&page='. $pagination->total_pages(). '><img src ='. WEBSITE.DS. APP_ROOT.DS. 'images/last.png /></a></p>';
...
<a href="<?php echo '/'. APP_ROOT.'/';?>staff/edit?id=<?php echo $staff->id?>" target="_blank">[Edit Profile]</a>&nbsp;&nbsp;
