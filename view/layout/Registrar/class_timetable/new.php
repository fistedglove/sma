...
<?php if($session->get_message() == 'Please fill all the fields!'):?>
<div class="newTimetableMsg"><?php echo flash_message($session->get_message());?></div>
<?php elseif($session->get_message() != 'Please fill all the fields!'):?>
<div class="newGreenTimetableMsg"><?php echo flash_message($session->get_message());?></div>
<?php endif;?>
<h3 class="title">New Class Schedule</h3>
