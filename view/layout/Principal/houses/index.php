...
<?php if($pagination->total_pages()>1){
    ...
    echo '<p><a class = "navLinks" href ='. '/'. APP_ROOT.'/'.'houses?page=1><img src ='. WEBSITE.DS. APP_ROOT.DS. 'images/first.png /></a>
    &nbsp&nbsp<a class = "navLinks" href ='. '/'. APP_ROOT.'/'.'houses?page='. $pagination->prev_page(). '><img src ='. WEBSITE.DS. APP_ROOT.DS. 'images/previous.png /></a>';
