...
<td class="score"><?php echo $score['grade']; ?></td>
<td class="score"><?php echo $score['effort']; ?></td>
...
<?php else:?>
<div id="emptyResult">
<h2 style="height: 25em;">The Second Term Scores for this student has not been entered<h2>
</div>
<?php endif;?>
