...
<p><span>Academic Term:  </span>Third Term</p>
</div>
</div>
<br class="clear" />
...
<th class="score">1st Term Score<br />(100%)</th>
<th class="score">2nd Term Score<br />(100%)</th>
<th class="score">Weighted Average<br />(100%)</th>
...
<tr>
<td><a href="<?php echo '/'. APP_ROOT.'/';?>third_term_scores/edit?id=<?php echo $id;?>&sub=<?php echo $score['subject_name'];?>"><?php echo ucwords($score['subject_name']); ?></a></td>
...
<td class="score"><?php echo ucfirst($score['grade']); ?></td>
<td class="score"><?php echo ucfirst($score['effort']); ?></td>
<td class="score"><?php echo $score['first_term_score']; ?></td>
<td class="score"><?php echo $score['second_term_score']; ?></td>
<td class="score"><?php echo round($score['average_score'], 1); ?></td>
<td class="comment"><?php echo htmlspecialchars(ucfirst($score['teacher_comment'])); ?></td>
</tr>
<?php endforeach;?>
</tbody>
</table>
...
<div class="principal">
<p>--------------------------------Date-----------<br /><span class="principal">Principal Signature</span></p>
</div>
<div class="signature">
<p>-------------------------------<br /><span class="signature">Teacher Signature</span></p>
</div>
<p class="dashed">----------------------------------------------------------------------------------------------------------------------------------------------------------</p>
...
<?php else:?>
<h3 style="height: 25em;">The Third Term Scores for this student has not been entered</h3>
<?php endif;?>
