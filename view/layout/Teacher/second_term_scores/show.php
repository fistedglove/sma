...
<p><span>Academic Term:</span>Second Term</p>
</div>
</div>
<br class="clear" />
...
<tr>
<td><a href="<?php echo '/'. APP_ROOT.'/';?>second_term_scores/edit?id=<?php echo $id;?>&sub=<?php echo $score['subject_name'];?>"><?php echo ucwords($score['subject_name']); ?></a></td>
...
<?php else:?>
<h3 style="height: 25em;">The Second Term Scores for this student has not been entered</h3>
<?php endif;?>
