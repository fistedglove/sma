...
class First_term_scores extends DatabaseObject{
    ...
    protected $db_fields;
    protected static $table_name = 'first_term_scores';
    ...
    public static function get_result($student_id = null, $class_id = null, $limit = null, $offset = null){
        ...
        $query = '
                ...
                FROM students, houses, first_term_comments, first_term_scores, classes
                WHERE first_term_scores.student_id = students.id
                AND students.class_id = classes.id
                AND students.house_id = houses.id
                AND first_term_comments.student_id = students.id';
